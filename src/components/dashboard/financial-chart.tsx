  ...
  return (
    <section className="surface-panel">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h2 className="text-xl font-semibold tracking-tight text-white">Receitas x despesas</h2>
        </div>
      ...
      <div className="mt-8 h-80 min-h-80 w-full min-w-0">
        <ResponsiveContainer width="100%" height={320}>
          <BarChart data={data} barGap={8} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
            ...
            />
            <Bar dataKey="receitas" name="Receitas" fill="#6ee7b7" radius={[6, 6, 0, 0]} maxBarSize={40} />
            <Bar dataKey="despesas" name="Despesas" fill="#fda4af" radius={[6, 6, 0, 0]} maxBarSize={40} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </section>
